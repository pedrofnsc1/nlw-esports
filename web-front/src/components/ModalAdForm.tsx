...
export function ModalAdForm(){
  ...
  async function handleCreateAd(event: FormEvent){
    ...
    // Usar Validação de form em react;
    ...
    console.log('Enviaste o formulário')
  }
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10
             ...
             rounded-lg w-[480px] shadow-lg shadow-black/20">
              <Dialog.Title className="text-3xl font-semibold">Publique um anúncio</Dialog.Title>
